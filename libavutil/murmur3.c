...
static uint64_t __inline get_k1(const uint8_t *src)
{
...
static uint64_t __inline get_k2(const uint8_t *src)
{
...
static uint64_t __inline update_h1(uint64_t k, uint64_t h1, uint64_t h2)
{
    k ^= h1;
    k = ROT(k, 27);
    k += h2;
...
static uint64_t __inline update_h2(uint64_t k, uint64_t h1, uint64_t h2)
{
    k ^= h2;
    k = ROT(k, 31);
    k += h1;
...
static __inline uint64_t fmix(uint64_t k)
{
    k ^= k >> 33;
