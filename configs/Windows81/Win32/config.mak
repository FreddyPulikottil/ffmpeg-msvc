...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--toolchain=msvc --disable-dxva2 --arch=x86 --enable-shared --enable-cross-compile --target-os=win32 --extra-cflags='-MD -DWINAPI_FAMILY=WINAPI_FAMILY_PC_APP -D_WIN32_WINNT=0x0603' --extra-ldflags='-winmd -appcontainer' --prefix=../../../Build/Windows81/Win32
...
SRC_PATH=/d/gitRepos/ffmpeg
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 18.00.30501 for x86
ARCH=x86
INTRINSICS=none
CC=cl
CXX=g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -Dsnprintf=avpriv_snprintf -D_snprintf=avpriv_snprintf -Dvsnprintf=avpriv_vsnprintf
CFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -Dinline=__inline -FIstdlib.h -Dstrtoll=_strtoi64 -MD -DWINAPI_FAMILY=WINAPI_FAMILY_PC_APP -D_WIN32_WINNT=0x0603   -Z7 -W4 -wd4244 -wd4127 -wd4018 -wd4389 -wd4146 -wd4057 -wd4204 -wd4706 -wd4305 -wd4152 -wd4324 -we4013 -wd4100 -wd4214 -wd4307 -wd4273 -wd4554 -wd4701 -O2   -Oy-
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -nologo -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -Dinline=__inline -FIstdlib.h -Dstrtoll=_strtoi64 -MD -DWINAPI_FAMILY=WINAPI_FAMILY_PC_APP -D_WIN32_WINNT=0x0603 -Z7
AS_C=-c
AS_O=-Fo$@
CC_C=-c
CC_E=-P -Fi$@
...
DEPWINDRES=cl
DOXYGEN=doxygen
LDFLAGS= -winmd -appcontainer -nologo -libpath:ARGEADDRESSAWARE -debug
LDEXEFLAGS=
