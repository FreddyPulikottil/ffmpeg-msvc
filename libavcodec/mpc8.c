...
static __inline int mpc8_dec_base(GetBitContext *gb, int k, int n)
{
...
static __inline int mpc8_dec_enum(GetBitContext *gb, int k, int n)
{
    int bits = 0;
...
static __inline int mpc8_get_mod_golomb(GetBitContext *gb, int m)
{
